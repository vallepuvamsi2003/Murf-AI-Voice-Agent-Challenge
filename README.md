...
𝐀𝐈 𝐕𝐨𝐢𝐜𝐞 𝐀𝐠𝐞𝐧𝐭 𝐂𝐡𝐚𝐥𝐥𝐞𝐧𝐠𝐞  𝐛𝐲 𝐌𝐮𝐫𝐟 𝐀𝐈

𝐃𝐚𝐲 𝟏 – "𝐆𝐞𝐭 𝐘𝐨𝐮𝐫 𝐒𝐭𝐚𝐫𝐭𝐞𝐫 𝐕𝐨𝐢𝐜𝐞 𝐀𝐠𝐞𝐧𝐭 𝐑𝐮𝐧𝐧𝐢𝐧𝐠" AI Voice Agent by Murf AI

🔧 What I built Python backend integrated with the Murf AI Speech API Lightweight HTML/CSS/JavaScript frontend Browser-based voice interaction with real-time audio responses Successfully connected, tested, and had a short conversation with the agent 🎤🤖


𝐃𝐚𝐲 𝟐 - 𝐂𝐨𝐟𝐟𝐞𝐞 𝐒𝐡𝐨𝐩 𝐁𝐚𝐫𝐢𝐬𝐭𝐚 𝐀𝐠𝐞𝐧𝐭

I transformed the starter voice agent into a friendly coffee shop barista, trained under the fictional brand Falcon Coffee.
The agent now:
✅ Greets customers warmly like a real barista
✅ Takes voice-based coffee orders 
✅ Asks clarifying questions until the order is complete
...
✅ Asks about mood, energy, and stress levels
✅ Helps users set 1–3 realistic goals for the day
...
✅ Greet users warmly
 ...
 ✅ Answer company & product questions using a structured FAQ
 ✅ Collect lead details (name, company, role, email, use case, team size, timeline)
 ✅ Detect when the call ends
 ✅ Generate a clean JSON file containing lead details + a short call summary
...
🔐 𝐖𝐡𝐚𝐭 𝐈 𝐁𝐮𝐢𝐥𝐭
 ...
 ✔ Loads a fraud case when the call starts
 ✔ Verifies the customer through safe, non-sensitive questions
...
I designed a complete JSON catalog with:
Groceries: milk, eggs, bread, veggies
Snacks: chips, cookies
Prepared food: pizza, sandwiches
Tags like vegan, gluten-free, brand, size, category, etc.
🎯 2. Smart Voice Ordering Assistant
